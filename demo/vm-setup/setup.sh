...
case ${ID,,} in
    *suse)
    ...
    case $VAGRANT_DEFAULT_PROVIDER in
        ...
        libvirt)
        # vagrant-libvirt dependencies
        packages+=(qemu qemu-kvm libvirt-daemon-system libvirt-clients bridge-utils virtinst virt-manager ebtables \
		dnsmasq-base libxslt-dev libxml2-dev libvirt-dev zlib1g-dev ruby-dev libguestfs-tools build-essential)
        # NFS
